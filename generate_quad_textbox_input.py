...
class App(ShowBase):
    ...
    def setText(self, s):
        if 1>0:
            ...
            [self.x_origin, self.y_origin,self.z_origin] = solve_point_on_vector(0,0,0, time_period*0.5, i0*sent_vect[0],i1*sent_vect[1], i2*sent_vect[2])
            self.z_origin = -3
            ...
            for sub_sentence in sub_sentences:
                ...
                for word in sub_word_list:
                    ...
                    howOpaque=0.5+abs(color_value[2])*0.5
                    node_in.setColorScale(1,1,1,0.9)
